...
class UsuarioTest(TestCase):
    ...
    def test_create_user(self):
        usuario = Usuario.objects.create_contracting_user('teste@teste.com', '1q2w3e4r')
    ...
    def test_validation_create_user(self):
        ...
        for item in variacoes:
            usuario = Usuario.objects.create_contracting_user(item[0], '1q2w3e4r')
    ...
    def test_verify_criptography(self):
        ...
        for item in variacoes:
            usuario = Usuario.objects.create_contracting_user(item[0], item[1])
